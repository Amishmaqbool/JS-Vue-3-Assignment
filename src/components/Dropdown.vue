...
<template>
  <div class="relative">
    <button
      ...
      class="px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-opacity-50 transition duration-150 ease-in-out"
    >
      Dropdown
    </button>
      ...
      <div v-if="isOpen" class="absolute left-0 mt-1 w-56 rounded-md shadow-lg bg-white z-10">
        <ul class="py-1">
          <li
            ...
            class="px-4 py-2 hover:bg-gray-100 cursor-pointer transition duration-150 ease-in-out"
